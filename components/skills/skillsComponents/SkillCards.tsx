...
const colorMapBorder: Record<string, { border: string; bg: string }> = {
    blue: { border: 'border-blue-700', bg: 'bg-blue-400' },
    red: { border: 'border-red-700', bg: 'bg-red-400' },
    green: { border: 'border-green-700', bg: 'bg-green-400' },
    yellow: { border: 'border-yellow-700', bg: 'bg-yellow-400' },
    purple: { border: 'border-purple-700', bg: 'bg-purple-400' },
};
...
export const SkillCard = ({ skillName, skillLevel, description }: { skillName: string, skillLevel: '1' | '2' | '3' | '4', description?: string }) => {
    ...
    const colorClassesBorder = colorMapBorder[colorKey] || { border: 'border-gray-700' };
